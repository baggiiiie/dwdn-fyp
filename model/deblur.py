...
class DEBLUR(nn.Module):
    ...
    def forward(self, input, kernel):
        ...
        for i in range(first_scale_inblock_pad.shape[1]):
            ...
            #clear_feature_ch = torch.squeeze(clear_feature_ch,0)
            # print()
            # print(f'blur size: {blur_feature_ch.size()}')
            # print(f'clear_features.shape: {clear_features.shape}')
            # print(f'clear_feature_ch.shape: {clear_feature_ch.shape}')
        ...
        for level in range(self.n_levels):
            ...
            # print(first_scale_inblock.shape)
            ...
            # print((first_scale_decoder_second.shape, first_scale_encoder_first.shape))
            first_scale_decoder_first = self.decoder_first(first_scale_decoder_second+first_scale_encoder_first)
            # print(first_scale_decoder_first.shape, first_scale_inblock.shape)
